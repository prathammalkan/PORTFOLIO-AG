...
While Google's crawlers can execute JavaScript, they do it in a two-pass system. The first pass indexes the raw HTML. The second pass (rendering) is queued for later when resources are available. This means your beautifully crafted marketing copy might not be indexed for days, or worse, if your JavaScript is too heavy, the crawler might time out and index a blank page.
